...
| Word | Neighbors |
|------|-----------|
| harry | **he** (51865), **it** (78681), **i** (82270), ron (82806) |
| gryffindor | slytherin (1817), house (1884), fire (1937), class (1959) |
| chair | seat (943), bag (943), trunk (1044), letter (1078) |
| wand | head (4317), eyes (4791), hand (5083), face (5208) |
| good | long (3510), after (3687), its (3693), neville (3780) |
| enter | according (247), win (250), ignore (256), play (271) |
| on | from (18858), into (19465), at (20637), with (20710) |
| school | house (1503), castle (1837), place (1849), window (1869) |

### Manhattan (normalized)
| Word | Neighbors |
|------|-----------|
| harry | **he** (1603440), **it** (2026874), ron (2150968), hermione (2279334) |
| gryffindor | slytherin (58828), house (61588), class (64046), fire (64556) |
| chair | seat (30012), bag (31296), trunk (32024), letter (34510) |
| wand | head (141148), hand (156460), eyes (157320), face (173042) |
| good | neville (112650), long (112664), its (120132), sirius (122542) |
| enter | according (8502), win (8752), ignore (8872), play (9304) |
| on | with (532362), for (559012), from (562580), into (581106) |
| school | house (48736), castle (57618), place (59938), window (61988) |

### Observation
Cosine produces semantically meaningful neighbors with small distances (0.02–0.13). Euclidean and manhattan, even with normalized vectors, produce poor results for frequent words like `harry` — `he`, `it`, `i` appear as top neighbors, which makes no semantic sense. Distances are also much larger (thousands to millions).

### Conclusion
**Cosine is the preferred metric** — it captures semantic similarity well and is invariant to vector magnitude. Euclidean and manhattan are not suited for word embeddings even with normalization.
